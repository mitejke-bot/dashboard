...
class SppagebuilderAddonArticles extends SppagebuilderAddons
{
	...
	public function css()
	{
		...
		if ($layout !== 'default')
		{
			...
			$css .= $cssHelper->generateStyle('.sppb-addon-articles .sppb-addon-article-layout-content img, .sppb-addon-articles .sppb-addon-article-layout-content .embed-responsive-item', $settings, ['image_padding' => 'padding'], false);
			...
			{
				$css .= $cssHelper->generateStyle('.sppb-addon-articles .sppb-addon-article-layout-content img', $settings, ['image_height' => 'height']);
				$css .= $cssHelper->generateStyle('.sppb-addon-articles .sppb-addon-article-layout-content .embed-responsive-item', $settings, ['image_height' => 'height'], 'px !important');
			}
