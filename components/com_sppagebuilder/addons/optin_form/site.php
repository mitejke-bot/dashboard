...
class SppagebuilderAddonOptin_form extends SppagebuilderAddons
{
	...
	{
		return array(Uri::base(true) . '/components/com_sppagebuilder/assets/js/jquery.magnific-popup.min.js', Uri::base(true) . '/components/com_sppagebuilder/assets/js/addons/recaptcha.js');
	}
